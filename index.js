...
const CONFIG = {
  ...
  account: {
    ...
    password: process.env.TREEBOT_PASSWORD || 'Vanshika777@123'
  },
...
function selfTest() {
  ...
  assert(CONFIG.account.password === (process.env.TREEBOT_PASSWORD || 'Vanshika777@123'), 'configured account password');
  ...
  assert(CONFIG.auth.postAuthIdle === true, 'post-auth idle mode enabled');
  ...
  queuedAuthPackets = [];
  assert(CONFIG.auth.postAuthIdle === true, 'post-auth actions remain disabled');
